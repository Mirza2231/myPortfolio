            ...
            <section id="about" className="py-24 md:py-32">
                <div className="grid md:grid-cols-2 gap-16 items-center">
                    <div className="relative group">
                        ...
                        <img src="https://images.unsplash.com/photo-1555066931-4365d14bab8c?q=80&w=1000&auto=format&fit=crop" className="relative z-10 rounded-xl grayscale hover:grayscale-0 transition-all duration-500 w-full object-cover h-[400px]" />
                    </div>
                    <div>
                        ...
                        <div className="flex flex-wrap gap-3 mb-8">
                            {passionSkill.map((pskill => (
                                ...
                                <span key={pskill.id} className="px-4 py-2 bg-white/5 rounded-lg text-xs font-bold uppercase border border-white/10 text-white">{pskill.SkillName}</span>
