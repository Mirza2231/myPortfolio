  ...
  const skillList = [
    {
      ...
      category: "Frontend",
      Icon: FaReact,
      hoverColor: "group-hover:text-[#5ED3F3]"
    },
    {
      id: 2,
      Sname: "Express.js",
    ...
    },
    {
      ...
      hoverColor: "group-hover:text-[#0BACF5]"
    },
        {
      id: 8,
      Sname: "DotNet",
      category: "Framework",
      Icon: SiDotnet,
      hoverColor: "group-hover:text-[#c599f7]"
    },
        {
      id: 9,
      Sname: "Sql",
      category: "Database",
      Icon: TbFileTypeSql,
      hoverColor: "group-hover:text-[#B82323]"
    },
        {
      id: 10,
      Sname: "Php",
      category: "Language",
      Icon: FaPhp ,
      hoverColor: "group-hover:text-[#6D88BC]"
    },
        {
      id: 11,
      Sname: "CSS",
      ...
      category: "Framwork",
      Icon: FaBootstrap ,
      hoverColor: "group-hover:text-[#9C57D5]"
    },
      ...
      <section className="py-32 border-t border-white/5">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          {skillList.map(skills => (
            ...
            <div key={skills.id} className="bg-bg-card border border-white/10 p-6 rounded-xl flex items-center gap-4 hover:border-accent/50 transition-colors group">
